...
const recognition = new (window.SpeechRecognition ||
  ...
  btn.addEventListener("click", function () {
    ...
    function handleCommand(command) {
      ...
      if(command.includes("hey who are you"))
        {
        speak("hello sir,my name is Ai bot your very own assistant");
    
        }else if(command.includes("who created you")){
        speak("i am a virtual assistant ,created by Hritik");
      } else if (command.includes("open my portfolio")) {
        speak("Opening your portfolio website...");
        window.open("https://hritik-designs.figweb.site/Hritik-Portfolio/", "_blank");
    ...
    speak("Hello Hritik, how can I help you?");
